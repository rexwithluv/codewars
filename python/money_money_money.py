...
does, he wants to know how many years 'Y' this sum 'P' has to be kept in
...
Desired Principal 'D' is equal to Principal 'P' this should return 0
Years."""


def calculate_years(principal: int, interest: float, tax: float, desired: int) -> int:
    years = 0
