...
that represents material 1-8. Your task is to determine if the formula
...
- All inputs are valid. Array contains at least 1 digit. Each digit
...
def is_valid(formula: list[int]) -> bool:
