...
take a flower and tear its petals, saying each of the following phrases
...
at the last petal for a flower of a given number of petals. The number
of petals is always greater than 0. """
