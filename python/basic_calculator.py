...
character is "+" , "-", "*", or "/", the function will return the result
of the corresponding mathematical function on the two numbers. If the
string is not one of the specified characters, the function should
...
is made, return null (throw an `ArgumentException` in C#)/(None in
Python)."""


def calculate(num1: int, operation: str, num2: int) -> int | None:
    try:
