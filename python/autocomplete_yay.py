...
def autocomplete(string: str, dictionary: list[str]):
    clean_string: str = "".join(i for i in string if i.isalpha())
    return [i for i in dictionary if i.lower().startswith(clean_string)][:5]
