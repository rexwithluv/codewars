...
Your function will return the index 3, because at the 3rd position of the array, the sum of left side of the index ({1,2,3}) and the sum of the right side of
...
def find_even_index(arr):
    for position, i in enumerate(arr):  # Para recorrer la lista    
...
""" def find_even_index(arr):
    for i in arr:  # Para recorrer la lista
