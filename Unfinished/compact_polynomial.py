...
Let's call this polynomial compact if it has **no repeating or zero**
integer roots and `$|a_n|$` is minimal.

Your task is to ﬁnd the maximum and minimum values of `$a_1$` in the
compact polynomial.

You're given the degree of the polynomial: `$n$`  `$(1≤n≤10^{18})$`.
