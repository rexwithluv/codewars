...
top-2 or top-1 words should be returned, or an empty array if a text
contains no words.
...
- Avoid creating an array whose memory footprint is roughly as big as
the input text.
...
def top_3_words(text: str) -> Tuple[Union[str, None]]:
    lst = clean(text).lower().split()
