...
What's the use of saying "Eureka"? Because this sum gives the same
number: ```$89 = 8^1 + 9^2$```
...
integers ```$a$```, ```$b$``` that defines the range ```$[a, b]$```
(inclusive) and outputs a list of the sorted numbers in the range that
