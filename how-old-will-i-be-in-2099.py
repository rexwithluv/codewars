...
Provide output in this format: For dates in the future: "You are ...
year(s) old." For dates in the past: "You will be born in ... year(s)."
If the year of birth equals the year requested return: "You were born
this very year!"

"..." are to be replaced by the number, followed and proceeded by a
single space. Mind that you need to account for both "year" and "years",
...
def calculate_age(year_of_birth: int, current_year: int) -> str:
    ...
    answer = "1 year" if years == 1 else f"{years} years"
    if year_of_birth < current_year:
        return f"You are {answer} old."
    else:
        return f"You will be born in {answer}."
