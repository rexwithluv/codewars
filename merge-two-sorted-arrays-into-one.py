...
asc order. Complete the function mergeArrays(arr1, arr2), where arr1 and
...
* [1, 3, 5, 7, 9, 11, 12], [1, 2, 3, 4, 5, 10, 12] -> [1, 2, 3, 4, 5, 7,
  9, 10, 11, 12]
```
...
def merge_arrays(arr1: List[str], arr2: List[str]) -> List[str]:
