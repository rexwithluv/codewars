...
obtained by continued summation of the natural numbers 1, 2, 3, 4, 5,
etc."
...
def sum_triangular_numbers(n: int):
    for c, i in enumerate(range(1, n + 1), 2):
        print(c + i)

sum_triangular_numbers(3)
